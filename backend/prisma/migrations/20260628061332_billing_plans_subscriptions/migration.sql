...
ALTER TYPE "LogAction" ADD VALUE 'PAYMENT_INITIATED';
ALTER TYPE "LogAction" ADD VALUE 'PAYMENT_RECEIVED';
ALTER TYPE "LogAction" ADD VALUE 'PAYMENT_FAILED';
ALTER TYPE "LogAction" ADD VALUE 'SUBSCRIPTION_ACTIVATED';
